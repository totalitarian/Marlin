...
#define STRING_CONFIG_H_AUTHOR "(Lee v2, default config)" // Who made the changes.
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -31.6 , -6.5, -2.15 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -31.6 , -6.5, -3.2 }
